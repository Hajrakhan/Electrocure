...
class Ofd_Card extends StatelessWidget {
  outfeeder ofd;
  Ofd_Card(this.ofd);
  ...
  Widget build(BuildContext context) {
    ...
    DateTime lastpulse=ofd.datetime;
    ...
    if (difference<15) {
      ...
      avgPowerFactor = avgvoltage(
          double.parse('${ofd.pf1}'),
          double.parse('${ofd.pf2}'),
          double.parse('${ofd.pf3}'));
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 10,),
                          Text('${ofd.kvaCapacity} KVA',style: TextStyle(fontSize: 14)),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${ofd.datetime}',style: TextStyle(fontSize:12,color: Colors.grey)),
                      SizedBox(height: 5,),
                      RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(
                              ...
                              builder: (BuildContext context) => details(ofd.fdid,avg_voltage,total_current,KVA,"load_device_graph","3")));
                        },
                        child: Text("Details",),
                      )
                    ],
