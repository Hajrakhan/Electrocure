...
class TransformerCard extends StatelessWidget {
  Transformers transformer;
  TransformerCard(this.transformer);
  ...
  Widget build(BuildContext context) {
    ...
    if (difference<15) {
      ...
      avgPowerFactor = avgvoltage(
          double.parse('${transformer.pf1}'),
          double.parse('${transformer.pf2}'),
          double.parse('${transformer.pf3}'));
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                InkWell(
                  onTap: (){
                    var url1="http://uetpswr.cisnr.com/electrocure/app/dbselect.php";
                    Navigator.pushNamed(context,'/db_Dashboard',arguments: {
                      'url1': url1,
                      'args': transformer.trid
                    });
                  },
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 10,),
                          Text('${transformer.kvaCapacity} KVA',style: TextStyle(fontSize: 14)),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text("${transformer.trid}",style:style2),
                        ],
                      ),
                      SizedBox(height:5),
                      Row( children: [
                      ...
                      Text('${transformer.datetime}',style: TextStyle(fontSize:12,color: Colors.grey)),
                      SizedBox(height: 5,),
                      RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(
                              ...
                              builder: (BuildContext context) => details(transformer.trid,avg_voltage,total_current,KVA,"load_device_graph","3")));
                        },
                        child: Text("Details",),
                      )
                    ],
